# Template configured with both DynamoDB and AmpDB
...
## Prerequisites
The api consumes the ISCx backend common utils as npm package. Since this package is restricted and limited to ISCx devs, developer will have to follow the steps listed below to generate and add a token to the .npmrc file:
...
```
PORT='3001'
AMP_DB_HOST='value can be found at -> aws secret manager -> iscx/amp-db/dev'
